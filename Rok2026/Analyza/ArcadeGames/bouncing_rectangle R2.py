"""
 ...
 Úloha 1 - prepisany program do objektově orientované podoby - přidána třída Rectangle, která obsahuje všechny informace o obdélníku a metody pro jeho pohyb a vykreslení.
...
class BouncingRectangleGame:
    def __init__(self, width=700, height=500, title="Bouncing Rectangle"):
        ...
        self.rectangle = Rectangle(50, 50)
