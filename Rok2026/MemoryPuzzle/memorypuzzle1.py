...
# More info at https://inventwithpython.com/pygame/chapter17.html
# Pracovný kód k 17. kapitole knihy "Invent Your Own Computer Games with Python" od Al Sweigarta.
# Detailne analyzovaný pre vlastné pochopenie a následné úpravy.
...
BOXSIZE = 40  # size of box height & width in pixels - veľkosť box v pixeloch
...
# 70 >= 70 - väčší počet ikon než je potřeba pro velikost desky, takže hra bude fungovat i když se přidají další tvary nebo barvy
# 70 = 7 barev * 5 tvarů * 2 (protože každý tvar a barva musí být ve dvojici)
# pre väčšiu desku je potřeba více ikon, takže se musí přidat další barvy nebo tvary
